...
# Always set SMTP configuration (environment variables will be used if backend is SMTP)
...
DEFAULT_FROM_EMAIL = env("DJANGO_DEFAULT_FROM_EMAIL", default="care@spicelush.com")
